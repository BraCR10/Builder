...
public class BiciPersonalizadaBuilder extends BicBuilder {

    public BiciPersonalizadaBuilder() {
        super(160.0f);
    }
    ...
    public void agregarCanasta() {
        this.bicicleta.setTieneCanasta(true);
        this.bicicleta.agregarCostoFeature(20.0f);
    }
